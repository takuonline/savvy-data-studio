model_list = [
    ...
    {"id": "tts-1-1106", "object": "model", "owned_by": "system"},
...
# try:
#     import openai
#     OPEN_AI_MODEL_CHOICES = [i["id"],i["id"])  for i in openai.Model.list().data]
# except:
OPEN_AI_MODEL_CHOICES = [(i["id"], i["id"]) for i in model_list]
